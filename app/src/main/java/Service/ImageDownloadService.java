...
import com.android.login.ImageDownloadActivity;
import com.android.login.RetrofitInterface;
...
//        Call<ResponseBody> request = retrofitInterface.downloadImage("img/Sample-jpg-image-50kb.jpg");
    ...
    private void sendProgressUpdate(boolean downloadComplete) {
        ...
        Intent intent = new Intent(ImageDownloadActivity.PROGRESS_UPDATE);
        intent.putExtra("downloadComplete", downloadComplete);
        LocalBroadcastManager.getInstance(ImageDownloadService.this).sendBroadcast(intent);
    }
